...
function aboutGame() {
    var codHtml = '<div class="gamebox about"><h2>Sobre</h2><br><p>Projeto desenvolvido no bootcamp "GFT START_UNI 2021 #1", realizado pela DIO com parceria com a GFT, objetivo do projeto foi recriar o jogo do dinossauro do Google quando estamos sem internet.</p><a target="_blank" href="https://github.com/luisfernandospindola"><input type="button" class="btn" value="GITHUB"></a><a target="_blank" href="https://www.linkedin.com/in/luisfernandospindola/"><input type="button" class="btn" value="LINKEDIN"></a><input type="button" class="btn" onClick="resetGame()" value="VOLTA AO MENU"></div>';
    document.body.innerHTML = codHtml;
}
